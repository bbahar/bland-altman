...
#### Assessing aggreement between **`r input$m1`** (reference method) and **`r input$m2`** (test method) measurements by means of Bland-Altman and scatter plots.

#### Data is processed using R language^1^, shiny web application framework^2^ and mcr package^3^. Shinydashboard^4^ and rhandsontable^5^ are used for website construction.
